...
if __name__ == "__main__":
    ...
    print(new_model)
    import sys
    sys.path.append('/Users/raffaelemartone34gmail.com/Desktop/Politecnico/Tesi/Repo/Organoid-Image-Classification-Using-Deep-Learning/ML_Decoder-main/src_files')
