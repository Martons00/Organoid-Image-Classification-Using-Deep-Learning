...
def main_worker(gpu, args):
    ...
    if args.similarity_loss != "":
        print(f"Using similarity loss: {args.similarity_loss} with weight {args.similarity_loss_weight}")
        logger.info(f"Using similarity loss: {args.similarity_loss} with weight {args.similarity_loss_weight}")
