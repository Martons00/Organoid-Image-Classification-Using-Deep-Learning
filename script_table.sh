...
python table_training.py outputs/OrganoidsINRIA_reduced_64/swinunetr > tables/results_testing/swinunetr_64_reduced_result.md
#python table_training.py outputs/OrganoidsINRIA_reduced/swinvit > tables/results_testing/swinvit_reduced_result.md
python table_training.py outputs/OrganoidsINRIA_reduced_64/densenet > tables/results_testing/densenet_64_reduced_result.md
python table_training.py outputs/OrganoidsINRIA_reduced_64/resnet18 > tables/results_testing/resnet18_64_reduced_result.md