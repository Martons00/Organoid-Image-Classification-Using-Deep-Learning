...
Visualizzazione migliorata con piani ortogonali (XY, YZ, XZ)
Autore: Assistant 
Data: Settembre 2025
"""
...
def main():
    ...
    """
    print("🚀 VISUALIZZATORE TIFF 3D CON VISTE ORTOGONALI")
    print("=" * 50)
    print("🎯 Funzionalità:")
    ...
    print("\n🎯 Vantaggi delle viste ortogonali:")
    print(" 📊 XY (Assiale) - vista dall'alto, mostra strutture nel piano")
    print(" 📊 YZ (Sagittale) - vista laterale, mostra la profondità Z")
    print(" 📊 XZ (Coronale) - vista frontale, altra prospettiva della profondità")
